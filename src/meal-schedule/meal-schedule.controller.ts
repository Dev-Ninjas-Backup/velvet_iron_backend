...
export class MealScheduleController {
    ...
    @ValidAll()
    @ApiBearerAuth()
    @ApiOperation({ summary: 'Create a meal schedule (calories auto-calculated)' })
    @ApiResponse({
        status: 201,
    ...
    @ApiBody({
        description: 'Meal schedule data — provide carbs, protein, fats and calories will be auto-calculated',
        schema: {
            type: 'object',
    ...
    @ValidAll()
    @ApiBearerAuth()
    @ApiOperation({ summary: 'Update meal schedule by ID (calories auto-recalculated)' })
    @ApiParam({
        name: 'id',
    ...
    @UseInterceptors(AnyFilesInterceptor())
    @ApiBody({
        description: 'Updated meal schedule data (all fields optional, calories auto-recalculated)',
        schema: {
            type: 'object',
            properties: {
                mealType: {
